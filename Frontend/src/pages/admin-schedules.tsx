        ...
        <div className="mb-8 flex justify-center items-center gap-4">
          <div className="relative flex-grow max-w-lg">
            ...
            <input
              ...
              className="w-full border-b-2 border-neutral-300 dark:border-neutral-700 focus:outline-none focus:border-primary py-2 pl-10 pr-4 bg-transparent"
              value={searchTerm}
            ...
            >
                ...
                >
                    ...
                    <div className="bg-neutral-50 dark:bg-neutral-900/50 px-6 py-4 flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-3 rounded-b-2xl">
                        <button type="button" disabled={isCancelling} className="mt-3 sm:mt-0 w-full inline-flex justify-center rounded-lg border border-neutral-300 dark:border-neutral-600 shadow-sm px-4 py-2 bg-white dark:bg-neutral-700 text-base font-medium text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-600 disabled:opacity-50" onClick={() => setIsModalOpen(false)}>
                            Voltar
                        </button>
